import 'package:demo_drap_drop_list_view/model/draggable_item_model.dart';
import 'package:demo_drap_drop_list_view/model/draggable_list_model.dart';

List<DraggableListModel> allLists = [
  DraggableListModel(
    header: 'Best Fruits',
    items: [
      DraggableItemModel(
